...
export default function CartTable() {
  ...
  return (
    <div className="min-h-80 max-w-4xl mx-auto, w-full font-primary">
      <table className="w-full">
        <thead>
          <tr className="uppercase text-sm text-primary dark:text-light border-b border-primary dark:border-light">
            ...
            <th className="px-4 sm:px-6 py-4">Remove</th>
          </tr>
        </thead>
        <tbody className="divide-y divide-primary dark:divide-light">
          {cart.map((item) => (
            ...
            >
              ...
              <td className="px-4 sm:px-6 py-4">${item.price.toFixed(2)}</td>
              <td className="px-4 sm:px-6 py-4">
                <button
